...
<noscript>
    <div
        class="fixed z-100 flex h-screen w-screen flex-col items-center justify-center gap-5 bg-slate-800 text-center text-white"
    >
        <div class="text-3xl">Unfortunately, this application requires JavaScript :(</div>
        <div class="text-xl">
